...
export default function DashboardClient({ workspaceId, role, slackUserId }: { workspaceId: string; role: string; slackUserId: string }) {
  return (
      <Suspense fallback={
        ...
        <DashboardContent workspaceId={workspaceId} role={role} slackUserId={slackUserId} />
      </Suspense>
  );
}
...
function DashboardContent({ workspaceId, role, slackUserId }: { workspaceId: string; role: string; slackUserId: string }) {
  ...
  // WorkspaceId is guaranteed by the Server Component.
